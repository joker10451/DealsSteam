...
ЖЁСТКИЕ ПРАВИЛА:
- МАКСИМУМ 5 строк. Не больше. Считай строки.
...
строка 1: <b>🔥 [Название] — −[скидка]%</b> (крючок, жирным)
строка 2: одна причина почему игра крутая (без воды)
строка 3: 💰 [старая цена] → <b>[новая цена]</b>
строка 4: одна фраза усиления (насколько дёшево / редко)
строка 5: автодожим со ссылкой на канал

Пиши как человек, не как бот. Стиль меняй каждый раз."""
