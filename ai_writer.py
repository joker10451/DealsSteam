...
_STYLES = [
    ...
    "как парень который сам только что взял и доволен — пишет от мужского лица",
...
- Если пишешь от первого лица — ТОЛЬКО мужской род: "купил", "взял", "не могу оторваться"
...
строка 5: короткий призыв к действию без ссылок, например: 👉 Бери пока не подняли цену
